...
int main() {
    ...
    for (int i = 0; i < MAX_rand; i++) {
        ...
        snprintf(
            query,
            500,
            "INSERT INTO %s (id_venda, data_venda, id_produto, id_cliente, valor_total, bitmap_idx_produtos, bitmap_idx_clientes) VALUES (%d, '2022-01-01', %d, %d, %f, 0x01, 0x01);",
            CONFIG.table, i + 1, i + 1, i + 1, (i + 1) * 100.0);
